...
<body>
<h1 style="text-align: center;margin: 70px 30px 30px 30px;font-size: 30px;font-weight: bolder">기업회원가입</h1>
...
<form style="padding: 0">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            <label for="busLisence">사업자 등록번호</label>
            <button type="button" class="btn btn-secondary" style="font-size: 10px;padding: 5px;margin: 10px" >중복 확인</button><br>
            <input type="text" class="form-control" id="busLisence" placeholder="사업자 등록번호를 입력해 주세요"><br>
        </div>
        <div class="form-group">
